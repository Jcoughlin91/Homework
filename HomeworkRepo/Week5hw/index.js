...
const web = data.map((user) => `${user.website + user.email}`);
console.log(web);

const user9toDos = toDos.filter((toDos) => toDos.userId === 9);
console.log(user9toDos);

const user9tasks = user9toDos.filter((tasks) => tasks.completed === false);
console.log(user9tasks.length);
